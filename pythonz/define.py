...
# pythonz root path
ROOT = os.getenv(
    "PYTHONZ_ROOT", os.path.join(os.environ["HOME"], ".pythonz")
)
...
PATH_SCRIPTS_PYTHONZ_INSTALLER = os.path.join(
    PATH_SCRIPTS_PYTHONZ, "installer"
)
...
# pythonz home path
PATH_HOME = os.getenv(
    'PYTHONZ_HOME', os.path.join(os.environ["HOME"], ".pythonz")
)
...
# pythonz download
PYTHONZ_UPDATE_URL = os.getenv(
    'PYTHONZ_UPDATE_URL',
    'https://github.com/saghul/pythonz/archive/master.tar.gz'
)
